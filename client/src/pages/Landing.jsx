...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#f6f7fb] text-gray-950 dark:bg-[#090d16] dark:text-white">
      {/* HEADER */}
      ...
      <main className="mx-auto max-w-7xl px-4 pb-10 sm:px-6">
        <section className="grid items-center gap-12 py-8 lg:min-h-[calc(100vh-88px)] lg:grid-cols-[0.92fr_1.08fr]">
          {/* LEFT SECTION */}
